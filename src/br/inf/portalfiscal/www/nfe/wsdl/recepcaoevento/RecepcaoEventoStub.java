   ...
   public RecepcaoEventoStub(org.apache.axis2.context.ConfigurationContext configurationContext,
    ...
    public RecepcaoEventoStub(java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
        this(null,targetEndpoint);
                     ...
                     * 
                     * @see br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEvento#nfeRecepcaoEvento
                     * @param nfeDadosMsg0
                     ...
                     */
                            ...
                            public  br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult nfeRecepcaoEvento(

                            br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg nfeDadosMsg0,br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE nfeCabecMsg1)
              ...
              org.apache.axiom.soap.SOAPEnvelope env = null;
                                                    ...
                                                    nfeDadosMsg0,
                                                    optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento",
                                                    "nfeRecepcaoEvento")), new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento",
                                                    "nfeRecepcaoEvento"));
                                        ...
                                        if (nfeCabecMsg1!=null){
                                                    ...
                                                    org.apache.axiom.om.OMElement omElementnfeCabecMsg1 = toOM(nfeCabecMsg1, optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", "nfeRecepcaoEvento")));
               ...
               org.apache.axis2.context.MessageContext _returnMessageContext = _operationClient.getMessageContext(
                ...
                org.apache.axiom.soap.SOAPEnvelope _returnEnv = _returnMessageContext.getEnvelope();
                                ...
                                java.lang.Object object = fromOM(
                                             ...
                                             br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult.class,
                                              getEnvelopeNamespaces(_returnEnv));

                               
                                        return (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult)object;
                                   
         }catch(org.apache.axis2.AxisFault f){

            org.apache.axiom.om.OMElement faultElt = f.getDetail();
            if (faultElt!=null){
                if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"nfeRecepcaoEvento"))){
                    //make the fault by reflection
                    try{
                        java.lang.String exceptionClassName = (java.lang.String)faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"nfeRecepcaoEvento"));
                        java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                        java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(String.class);
                        java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());
                        //message class
                        java.lang.String messageClassName = (java.lang.String)faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"nfeRecepcaoEvento"));
                ...
                * 
                * @see br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEvento#startnfeRecepcaoEvento
                    * @param nfeDadosMsg0
                        ...
                        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                            ...
                            try {
                                org.apache.axiom.soap.SOAPEnvelope resultEnv = resultContext.getEnvelope();
                                        ...
                                        callback.receiveResultnfeRecepcaoEvento(
                                        (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult)object);
                                        
                            } catch (org.apache.axis2.AxisFault e) {
                                callback.receiveErrornfeRecepcaoEvento(e);
                            }
                            }
									...
									if (faultElt!=null){
										if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"nfeRecepcaoEvento"))){
											...
											try{
										            ...
										            callback.receiveErrornfeRecepcaoEvento(new java.rmi.RemoteException(ex.getMessage(), ex));
                                            } catch(java.lang.ClassCastException e){
                                                // we cannot intantiate the class - throw the original Axis fault
                                                callback.receiveErrornfeRecepcaoEvento(f);
                                            } catch (java.lang.ClassNotFoundException e) {
                                                // we cannot intantiate the class - throw the original Axis fault
                                                callback.receiveErrornfeRecepcaoEvento(f);
                                            } catch (java.lang.NoSuchMethodException e) {
                            ...
                            public void onComplete() {
                                try {
                                    ...
                                    callback.receiveErrornfeRecepcaoEvento(axisFault);
                                }
                            }
                });
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento");
        ...
        */
        ...
        public static class ExtensionMapper{
          ...
          public static java.lang.Object getTypeObject(java.lang.String namespaceURI,
                  ...
                  if (
                  "http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento".equals(namespaceURI) &&
        ...
        public static class NfeRecepcaoEventoResult
        implements org.apache.axis2.databinding.ADBBean{
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":nfeRecepcaoEventoResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "nfeRecepcaoEventoResult",
    ...
    public static class Factory{
        ...
        *                If this object is a complex type, the reader is positioned at the end element of its outer element
        */
        public static NfeRecepcaoEventoResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NfeRecepcaoEventoResult object =
                new NfeRecepcaoEventoResult();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"nfeRecepcaoEventoResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NfeRecepcaoEventoResult)ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
    ...
    public static class Factory{
        ...
        */
        ...
        /* This type was generated from the piece of schema that had
                name = nfeCabecMsg
                Namespace URI = http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento
                Namespace Prefix = 
                */
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localCUFTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento",
                                                                      "cUF"));
    ...
    public static class Factory{
        ...
        */
        public static NfeCabecMsg parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            private  org.apache.axiom.om.OMElement  toOM(br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg.MY_QNAME,
            ...
            private  org.apache.axiom.om.OMElement  toOM(br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
                                        ...
                                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                                        throws org.apache.axis2.AxisFault{
                                                    ...
                                                    try{
                                                            ...
                                                            emptyEnvelope.getBody().addChild(param.getOMElement(br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg.MY_QNAME,factory));
        ...
        */
        ...
        try {
                ...
                if (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg.class.equals(type)){
                
                           return br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult.class.equals(type)){
                
                           return br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE.class.equals(type)){
                
                           return br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
